...
Partial Class frmNguoiDung
    ...
    Private Sub InitializeComponent()
        ...
        CType(dgvDanhSachNguoiDung, ComponentModel.ISupportInitialize).BeginInit()
        SuspendLayout()
        ' 
        ' btTimKiem
        ' 
        ...
        Label1.Name = "Label1"
        Label1.Size = New Size(416, 31)
        Label1.TabIndex = 31
        Label1.Text = "QUẢN LÝ NGƯỜI DÙNG - TÀI KHOẢN"
        Label1.TextAlign = ContentAlignment.MiddleCenter
        ' 
        ' dgvDanhSachNguoiDung
        ' 
        dgvDanhSachNguoiDung.AllowUserToOrderColumns = True
        dgvDanhSachNguoiDung.Anchor = AnchorStyles.Top Or AnchorStyles.Bottom Or AnchorStyles.Left Or AnchorStyles.Right
        ...
        Controls.Add(btThem)
        Controls.Add(Label1)
        Controls.Add(dgvDanhSachNguoiDung)
        Name = "frmNguoiDung"
        Text = "Quản Lý Tài Khoản Người Dùng"
        CType(dgvDanhSachNguoiDung, ComponentModel.ISupportInitialize).EndInit()
        ResumeLayout(False)
        PerformLayout()
    End Sub
