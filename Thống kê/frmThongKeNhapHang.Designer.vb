...
Partial Class frmThongKeNhapHang
    ...
    Private Sub InitializeComponent()
        ...
        Label1.Name = "Label1"
        Label1.Size = New Size(502, 31)
        Label1.TabIndex = 24
        Label1.Text = "THỐNG KÊ NHẬP KHO THEO NHÀ CUNG CẤP"
        ...
        Name = "frmThongKeNhapHang"
        StartPosition = FormStartPosition.CenterScreen
        Text = "Thống Kê Nhập Hàng"
