...
Partial Class frmThongKeSanPhamNhap
    ...
    Private Sub InitializeComponent()
        ...
        Label1.TabIndex = 11
        Label1.Text = "THỐNG KÊ SẢN PHẨM NHẬP KHO"
        ...
        Name = "frmThongKeSanPhamNhap"
        StartPosition = FormStartPosition.CenterScreen
        Text = "Thống Kê Sản Phẩm Nhập"
