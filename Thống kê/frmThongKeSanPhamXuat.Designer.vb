...
Partial Class frmThongKeSanPhamXuat
    ...
    Private Sub InitializeComponent()
        ...
        Label1.Location = New Point(210, 75)
        Label1.Margin = New Padding(3)
        Label1.Name = "Label1"
        Label1.Size = New Size(381, 31)
        Label1.TabIndex = 18
        Label1.Text = "THỐNG KÊ SẢN PHẨM XUẤT KHO"
        ...
        dgvThongKeSoLuong.TabIndex = 17
        ' 
        ' frmThongKeSanPhamXuat
        ' 
        ...
        Name = "frmThongKeSanPhamXuat"
        StartPosition = FormStartPosition.CenterScreen
        Text = "Thống Kê Sản Phẩm Xuất"
